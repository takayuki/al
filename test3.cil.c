...
#line 33
    __assert13("test3.c", 33, "node_cmp", "x != 0");
  }
#line 34
  if (! ((unsigned int )y != (unsigned int )((struct tree_node *)0))) {
#line 34
    __assert13("test3.c", 34, "node_cmp", "y != 0");
  }
#line 35
...
#line 34
  ...
  TxLoadSized(self, (intptr_t *)(& mem5), (intptr_t *)(& y->key), sizeof(long ));
#line 35
  return ((int )(mem4 - mem5));
  }
}
}
#line 29 "test3.c"
...
#line 40
        if ((unsigned int )nested != (unsigned int )((nest_t *)0)) {
#line 41
          tmp18 = _stm_node_cmp(self->stmThread, x, y);
        } else {
#line 43
...
#line 40
        if ((unsigned int )nested != (unsigned int )((nest_t *)0)) {
#line 41
          tmp18 = _stm_TREE_RB_REMOVE(self->stmThread, head, elm);
        } else {
#line 43
          fetch_and_add1(& prof->threadsWaiting);
#line 44
...
#line 64
      if (nest->level < 0L) {
#line 65
        tmp18 = _raw_TREE_RB_REMOVE(head, elm);
      } else {
#line 67
        fetch_and_add1(& prof->invokeInLockMode);
#line 68
...
#line 40
        if ((unsigned int )nested != (unsigned int )((nest_t *)0)) {
#line 41
          tmp18 = _stm_TREE_RB_INSERT(self->stmThread, head, elm);
        } else {
#line 43
          fetch_and_add1(& prof->threadsWaiting);
#line 44
...
#line 64
      if (nest->level < 0L) {
#line 65
        tmp18 = _raw_TREE_RB_INSERT(head, elm);
      } else {
#line 67
        fetch_and_add1(& prof->invokeInLockMode);
#line 68
...
#line 40
        if ((unsigned int )nested != (unsigned int )((nest_t *)0)) {
#line 41
          tmp18 = _stm_TREE_RB_FIND(self->stmThread, head, elm);
        } else {
#line 43
          fetch_and_add1(& prof->threadsWaiting);
#line 44
...
#line 64
      if (nest->level < 0L) {
#line 65
        tmp18 = _raw_TREE_RB_FIND(head, elm);
      } else {
#line 67
        fetch_and_add1(& prof->invokeInLockMode);
#line 68
...
#line 40
        if ((unsigned int )nested != (unsigned int )((nest_t *)0)) {
#line 41
          tmp18 = _stm_TREE_RB_NEXT(self->stmThread, elm);
        } else {
#line 43
          fetch_and_add1(& prof->threadsWaiting);
#line 44
...
#line 40
        if ((unsigned int )nested != (unsigned int )((nest_t *)0)) {
#line 41
          tmp18 = _stm_TREE_RB_MINMAX(self->stmThread, head, val);
        } else {
#line 43
          fetch_and_add1(& prof->threadsWaiting);
#line 44
...
#line 64
      if (nest->level < 0L) {
#line 65
        tmp18 = _raw_TREE_RB_MINMAX(head, val);
      } else {
#line 67
        fetch_and_add1(& prof->invokeInLockMode);
#line 68
...
#line 46
  if (! r) {
#line 46
    __assert13("test3.c", 46, "add", "(r = (struct tree_node*)malloc(sizeof(*r)))");
  }
#line 47
  r->key = n;
#line 48
...
#line 40
        if ((unsigned int )nested != (unsigned int )((nest_t *)0)) {
#line 41
          tmp18 = _stm_lookup(self->stmThread, n);
        } else {
#line 43
          fetch_and_add1(& prof->threadsWaiting);
#line 44
