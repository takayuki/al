...
#define STM_LOCAL_WRITE(var, val)       TxStoreLocal(STM_SELF, \
                                                     (vintp*)(void*)&(var), \
                                                     (intptr_t)val)
#define STM_LOCAL_WRITE_F(var, val)     TxStoreLocal(STM_SELF, \
                                                     (vintp*)FP2IPP((&(var)), \
                                                     F2IPval))
#define STM_LOCAL_WRITE_P(var, val)     TxStoreLocal(STM_SELF, \
                                                     (vintp*)(void*)&(var), \
                                                     VP2IP(val))
